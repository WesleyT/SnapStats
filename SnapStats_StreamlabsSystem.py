...
def Execute(data):
    ...
    # New season
        ...
        try:
            ...
            CurrentRank = math.trunc(math.floor((CurrentRank - 30) / 5) * 5) + 3
            if CurrentRank < 10:
                CurrentRank = 10
            if CurrentRank > 70:
                CurrentRank = 70
        ...
        try:
            ...
            if msgAmount == 1 or msgAmount == 2 or msgAmount == 4 or msgAmount == 8:
                ...
                if RankCubes + msgAmount >= 7:
                    if RankCubes == 6 and msgAmount == 8:
                        CurrentRank += 1
                        HighestRank = CurrentRank
                        RankCubes -= 7 
                        if HighestRank % 10 == 0 and HighestRank < 92:
                            CurrentRank +=3
                            HighestRank +=3
                ...
                if CurrentRank > HighestRank:
                    HighestRank = CurrentRank
                    # gives extra 3 levels for ever 10 levels under 100
                ...
                if RankCubes - msgAmount < 0:
                    ...
                    if CurrentRank != 10 and CurrentRank != 100:
                        ...
                        if RankCubes < 0:
                            CurrentRank -=1
                            RankCubes += 7
                    #sets cubes to 0 if you are at 10 or 100 threshold
                    else: RankCubes = 0 
                else:
                    RankCubes -= msgAmount
